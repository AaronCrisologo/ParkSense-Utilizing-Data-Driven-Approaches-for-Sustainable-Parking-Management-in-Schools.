...
namespace GUI
{
    public partial class cics : Form
    {
        ...
        private void cics_Load(object sender, EventArgs e)
        {
            caller();
        }
        public void caller()
        ...
        public void slot1()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(1, "cics");
            if (status == "Available")
            {
        ...
        public void slot2()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(2, "cics");
            if (status == "Available")
            {
        ...
        public void slot3()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(3, "cics");
            if (status == "Available")
            {
        ...
        public void slot4()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(4, "cics");
            if (status == "Available")
            {
        ...
        public void slot5()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(5, "cics");
            if (status == "Available")
            {
        ...
        public void slot6()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(6, "cics");
            if (status == "Available")
            {
        ...
        public void slot7()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(7, "cics");
            if (status == "Available")
            {
        ...
        public void slot8()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(8, "cics");
            if (status == "Available")
            {
        ...
        public void slot9()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(9, "cics");
            if (status == "Available")
            {
        ...
        public void slot10()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(10, "cics");
            if (status == "Available")
            {
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    right = parking.ParkVehicle(nametxtbox.Text, vehicletypecombo.SelectedItem.ToString(), vehicletxtbox.Text, "yes", "cics");
                }
                else {
                    right = parking.ParkVehicle(nametxtbox.Text, vehicletypecombo.SelectedItem.ToString(), vehicletxtbox.Text, "no", "cics");
                }
        ...
        private void leavebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                bool might = parking.LeaveParking(vehicletxtbox.Text, "cics");
                if (might)
                {
