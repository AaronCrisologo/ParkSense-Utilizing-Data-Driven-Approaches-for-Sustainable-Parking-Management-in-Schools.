...
namespace GUI
{
    public partial class ceafa : Form
    {
        ...
        public void slot1()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(1, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot2()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(2, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot3()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(3, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot4()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(4, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot5()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(5, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot6()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(6, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot7()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(7, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot8()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(8, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot9()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(9, "ceafa");
            if (status == "Available")
            {
        ...
        public void slot10()
        {
            (string status, string vehiclenumber, string name) = parking.GetSlotStatus(10, "ceafa");
            if (status == "Available")
            {
        ...
        private void ceafa_Load(object sender, EventArgs e)
        {
            caller();
        }
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    right = parking.ParkVehicle(nametxtbox.Text, vehicletypecombo.SelectedItem.ToString(), vehicletxtbox.Text, "yes", "ceafa");
                }
                else
                {
                    right = parking.ParkVehicle(nametxtbox.Text, vehicletypecombo.SelectedItem.ToString(), vehicletxtbox.Text, "no", "ceafa");
                }
        ...
        private void leavebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                bool might = parking.LeaveParking(vehicletxtbox.Text, "ceafa");
                if (might)
                {
